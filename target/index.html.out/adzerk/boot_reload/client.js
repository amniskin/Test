...
var len__6061__auto___6924 = arguments.length;
var i__6062__auto___6925 = (0);
while(true){
if((i__6062__auto___6925 < len__6061__auto___6924)){
args__6068__auto__.push((arguments[i__6062__auto___6925]));

var G__6926 = (i__6062__auto___6925 + (1));
i__6062__auto___6925 = G__6926;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6922){
var vec__6923 = p__6922;
var opts = cljs.core.nth.call(null,vec__6923,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6923,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6923,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6923,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6923,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6920){
var G__6921 = cljs.core.first.call(null,seq6920);
var seq6920__$1 = cljs.core.next.call(null,seq6920);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6921,seq6920__$1);
});
